...
export function ParticleField({
  ...
  useEffect(() => {
    ...
    const drawScene = () => {
      ...
      // ease reveal alphas toward their targets. Labels only fit on wider
      // canvases; below that they would clip, so hide them on small screens.
      const labelsFit = w >= 720;
