...
| People | Headshot frames for Michael Bielski, Ivan Baxter, Allen Hubbard, and Louis Connelly. 1:1. These photos already appear on Team. |

## News

| Slot | Description |
|---|---|
| Inno | St. Louis Inno Startups to Watch 2025 — article image or Metablify team photo. 3:2. |
| Arch Grants | Arch Grants 2024 cohort announcement — event or award photo. 3:2. |
| Danforth launch | Danforth Technology Company launch announcement — Danforth Center exterior or the founding team. 3:2. |
| AgFunderNews | AgFunderNews launch coverage — Danforth Center campus photo. 3:2. |
| Big Ideas | Big Ideas 3.0 — Team Metablify on stage at the Danforth Center. 3:2. |

## Technology

| Slot | Description |
|---|---|
| Pipeline output | Representative Metablify output — pending the technical team. 16:9. |
